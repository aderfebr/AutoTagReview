  ...
  <div id="main">
    ...
    <div id="right">
      ...
      <div class="content-section results-section">
        <div id="input-container">
          <h3><i class="fa fa-table"></i> 批量分析结果</h3>
          
          <div v-if="batchResults.length > 0" class="results-container">
            <div v-if="isLoading && progress < 100" class="processing-indicator">
              <i class="fa fa-spinner fa-spin"></i>
              <span>正在处理第 {{ batchResults.length + 1 }} 条评论...</span>
            </div>
...
const analyzeBatch = async () => {
  ...
  try {
    ...
    for (let i = 0; i < comments.length; i++) {
      ...
      progress.value = Math.floor(((i + 1) / comments.length) * 100);
