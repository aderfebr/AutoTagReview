  ...
  <div id="main">
    ...
    <div id="right">
      <div class="content-section history-section">
        <div v-if="isLoadingHistory" class="processing-indicator">
          <i class="fa fa-spinner fa-spin"></i>
          <span>正在加载可视化数据</span>
        </div>
        <div v-else id="history-header">
          <div class="comment-section">
            <div class="comment-label">
              <h3><i class="fa fa-comments"></i>评论内容：</h3>
            </div>
            ...
            <div class="analysis-results">
              <div class="analysis-column">
                <div class="analysis-item">
                  ...
                  <div class="tag-list">
                    <span v-for="(tag, tagIndex) in currentItem.tfidf" :key="'tfidf-' + tagIndex" class="tag">{{ tag
                    }}</span>
              ...
              <div class="analysis-column">
                <div class="analysis-item">
                  ...
                  <div class="tag-list">
                    <span v-for="(tag, tagIndex) in currentItem.textrank" :key="'textrank-' + tagIndex" class="tag">{{ tag
                    }}</span>
                ...
                <div class="analysis-item">
                  ...
                  <div class="tag-list">
                    <span v-for="(tag, tagIndex) in currentItem.llm_wo" :key="'llmwo-' + tagIndex" class="tag">{{ tag
                    }}</span>
              ...
              <div class="analysis-column">
                <div class="analysis-item">
                  ...
                  <div class="tag-list">
                    <span v-for="(tag, tagIndex) in currentItem.llm_w" :key="'llmw-' + tagIndex" class="tag">{{ tag
                    }}</span>
...
.processing-indicator .fa-spinner {
  font-size: 40px;
