                ...
                <div class="analysis-results">
                  <div class="analysis-column">
                    <div class="analysis-item">
                      ...
                      <div class="tag-list">
                        <span v-for="(tag, tagIndex) in item.tfidf" :key="'tfidf-' + tagIndex" class="tag">{{ tag
                        }}</span>
                      </div>
                    </div>
                  ...
                  <div class="analysis-column">
                    <div class="analysis-item">
                      ...
                      <div class="tag-list">
                        <span v-for="(tag, tagIndex) in item.textrank" :key="'textrank-' + tagIndex" class="tag">{{ tag
                        }}</span>
                      </div>
                    </div>
                    ...
                    <div class="analysis-item">
                      ...
                      <div class="tag-list">
                        <span v-for="(tag, tagIndex) in item.llm_wo" :key="'llmwo-' + tagIndex" class="tag">{{ tag
                        }}</span>
                      </div>
                    </div>
                  </div>
